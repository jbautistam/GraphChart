...
public partial class NetworkView
{
    ...
    /// </summary>
    private Adorners.FrameworkElementAdorner feedbackAdorner = null;
    ...
    private bool DetermineConnectorItemDraggedOver(Point hitPoint, out ConnectorItem connectorItemDraggedOver, out object connectorDataContextDraggedOver)
    {
        ...
        var connectorItem = Tools.WfpUtils.FindVisualParentWithType<ConnectorItem>(hitItem);
    ...
    private void AddFeedbackAdorner(FrameworkElement adornedElement, object indicator)
    {
        ...
        //
        feedbackAdorner = new Adorners.FrameworkElementAdorner(adornerElement, adornedElement);
